...
public class SynchronizationExampleMainAtomic extends Thread {
...
//        System.out.println(Thread.currentThread().getName() + " exit ");
    ...
    public SynchronizationExampleMainAtomic(String name) {
        super(name);
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0 ; i < threads.length ; i++ ) {
            threads[i] = new SynchronizationExampleMainAtomic("Thread-number-" + i);
            threads[i].start();
        }
        System.out.println("========");
        System.out.println("========");
